...
#     try:
#         row.cover = (
#             get_cover(get_game_id(row.name, api_key, client_id), api_key, client_id).replace('t_thumb', 't_cover_big'))
#     except:
#         continue
# for row in session.query(Games):
#     try:
